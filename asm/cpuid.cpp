...
int main() {
    ...
    cpuid_s cpuid0 = get_cpuid(0), cpuid1 = get_cpuid(1),
            cpuid70 = get_cpuid(7, 0), cpuid71 = get_cpuid(7, 1);
    ...
    std::cout
        << "Highest Function Parameter: 0x" << std::hex << std::uppercase << hfp
        << "\nManufacturer:               " << id
